    ...
    for row in range(0, 3):
        ...
        for col in range(0, 9):
            if(platform.system() == 'Darwin'):
                ...
                # For windows users
                boxButton = tk.Button(gameWindow, font=("Chalkboard SE",30), width=3, height=2,
...
def gameWindow():
    ...
    # Add Text
    canvas2.create_text( screen_width/4.5,50, text = "Tambola Family Fun", font=("Chalkboard SE",50), 
                        fill="#3e2723")
...
def askPlayerName():
    ...
    canvas1.create_text( screen_width/4.5,screen_height/8, text = "Enter Name", 
                        font=("Chalkboard SE",60), fill="#3e2723")
    ...
    button = tk.Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, 
                       command=saveName, height=2, bg="red", bd=3)
...
def receiveMsg():
    ...
    while True:
        ...
        if (chunk in numbers and flashNumberLabel and not gameOver):
            ...
            gameOver = True
            canvas2.itemconfigure(flashNumberLabel, text = chunk, font = ('Chalkboard', 40))
